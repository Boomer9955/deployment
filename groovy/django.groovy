...
dockerImage = ''
env.credgitc='git'
env.urlapp='https://github.com/Boomer9955/django-project.git'
env.urlconf='https://github.com/Boomer9955/minikube.git'


dir("${WORKSPACE}/config"){
    git changelog: false, poll: false, credentialsId: "$env.credgitc", url: "$env.urlconf", branch: 'main'
}

stage('Building and push'){
    if(newimages.toBoolean()){
        dir("${WORKSPACE}/project"){
            git changelog: false, poll: false, credentialsId: "$env.credgitc", url: "$env.urlapp", branch: 'main'
